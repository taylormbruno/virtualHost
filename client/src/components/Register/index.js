...
this.setState({...this.state, verifyImg: true })
  ...
  handleInputChange = (event, data) => {
    ...
    console.log(change);
    this.setState({...this.state, eventFormObj: {...this.state.eventFormObj, [data.name]: data.value}})
  ...
  render() {
    return (
      <div className="scrollingContainer">
        <StyledSegment>
          ...
          <Form>
            ...
            <Grid>
              ...
              <Grid.Column width={8}>
                <button style={this.verifyBtn} onClick={this.verifyImg}>Verify Image</button>
              </Grid.Column>
              </Grid.Row>
            </Grid>
            <Form.Field
        ...
        {(this.state.event.active ? <StyledButton
          onClick={() => {
